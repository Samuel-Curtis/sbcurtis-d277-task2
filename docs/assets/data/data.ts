...
export const stateData = {
    data: {
        ...
        whyVirginiaTiles: [
            {
              title: 'tile 1 title from data',
              content: 'tile 1 content from data',
              imageUrl: 'assets/bar-chart.svg',
              imageAltText: 'tile 1 alt text'
            },
            {
              title: 'tile 2 title from data',
              content: 'tile 2 content from data',
              imageUrl: 'assets/bar-chart.svg',
              imageAltText: 'tile 2 alt text'
            },
            {
              title: 'tile 3 title from data',
              content: 'tile 3 content from data',
              imageUrl: 'assets/bar-chart.svg',
...
export const richmondData = {
    data: {
        name: 'Richmond',
        slogan: '',
        description: 'Richmond description from data',
        funFacts: [
            'Richmond fun fact 1 from data',
            'Richmond fun fact 2 from data',
            'Richmond fun fact 3 from data',
            'Richmond fun fact 4 from data',
            'Richmond fun fact 5 from data'
        ],
        categories: [
            {
              name: 'Dining',
...
export const roanokeData = {
    data: {
        name: 'Roanoke',
        slogan: '',
        description: 'Roanoke description from data',
        funFacts: [
            'Roanoke fun fact 1 from data',
            'Roanoke fun fact 2 from data',
            'Roanoke fun fact 3 from data',
            'Roanoke fun fact 4 from data',
            'Roanoke fun fact 5 from data'
        ],
        categories: [
            {
              name: 'Dining',
...
export const lynchburgData = {
    data: {
        name: 'Lynchburg',
        slogan: '',
        description: 'Lynchburg description from data',
        funFacts: [
            'Lynchburg fun fact 1 from data',
            'Lynchburg fun fact 2 from data',
            'Lynchburg fun fact 3 from data',
            'Lynchburg fun fact 4 from data',
            'Lynchburg fun fact 5 from data'
        ],
        categories: [
            {
              name: 'Dining',
